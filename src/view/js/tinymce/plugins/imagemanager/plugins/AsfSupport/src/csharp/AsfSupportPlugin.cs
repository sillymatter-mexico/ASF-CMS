...
namespace Moxiecode.Manager.Plugins {
	...
	/// </summary>
	public class AsfSupportPlugin : Plugin {
        public AsfSupportPlugin()
        {
		}
		...
		public override bool OnInit(ManagerEngine man) {
            ...
            if (context.Session["permalink"] != null )//&& (context.Session["permalink"].ToString() != "NewPublication099"))
            {
...
/*            else if (context.Session["permalink"].ToString() == "NewPublication099")
            {
                throw new Exception("Para subir archivos primero debe guardar la publicacion");
            }*/
            else
            {
