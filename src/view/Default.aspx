...
<asp:Content ContentPlaceHolderID="MainContent" ID="Contenido" runat="server">
  <%
      int elimit = GetRequestVar("LimiteEventos") != null ? (int)GetRequestVar("LimiteEventos") : int.MaxValue,
          climit = GetRequestVar("LimiteColumnas") != null ? (int)GetRequestVar("LimiteColumnas") : int.MaxValue;
      ...
      List<ContentElement> principalMenuCE = ContentElementFromMenu((asf.cms.bll.Menu)GetRequestVar("menu_acerca"), false);
      ...
      List<ContentElement> eventos = ContentElementFromPublications((List<PublicationVO>)GetRequestVar("eventos"), elimit);
      List<ContentElement> columnas = ContentElementFromPublications((List<PublicationVO>)GetRequestVar("columnas"), climit);
  %>
  <!-- Carrusel -->
  <div id="banner1" class="fondo2">
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1150px; height: 380px; overflow: hidden; visibility: hidden;">
      ...
      <div id ="ban1cont" data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 1150px; height: 380px; overflow: hidden;">
  ...
  <div id="fichas" class="fondo5">
    ...
    <% foreach (ContentElement evento in eventos) { %>
      <div class="child evento" texto="<%=asf.cms.util.Encoder.RemoveHTML(evento.ContentNews) %>">
        <h3><a href="<%=evento.Link %>" target="<%=evento.Target %>"><%=evento.Title %></a></h3>
...
-->
      ...
      <div class="<%=informesMenuClasses[counter] %>">
        <a class="hov" href="<%=elem.Link %>" target="<%=elem.Target %>">
          <div>
    ...
    <div id="Menu1Cont" class="flex">
      ...
      <div id="<%=elem.Title %>" class="child">
        ...
        <p style="text-align: right;">
          <a href="<%=elem.Link %>" target="<%=elem.Target %>">Ver más..
...
<img class="iconadmon" src="/view/assets/imagenes/iconos/<%=elem.Class %>_g.png" >
<img class="iconadmon" src="/view/assets/imagenes/iconos/<%=elem.Class %>.png" >
