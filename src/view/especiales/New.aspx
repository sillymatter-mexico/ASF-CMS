<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="New.aspx.cs" Inherits="asf.cms.view.especiales.New"  MasterPageFile="~/view/master/Admin.Master" EnableViewState="false" ValidateRequest="false" %>
...
<asp:Content ContentPlaceHolderID="head" ID="h" runat="server">
   <script type="text/javascript" src="../view/js/tinymce/jquery.tinymce.js"></script>
    ...
    <script type="text/javascript" src="../view/js/editPub.js"></script>
</asp:Content>

<asp:Content ContentPlaceHolderID="contenido" ID="cont"  runat="server">
<%
    asf.cms.model.EspecialesVO p = (asf.cms.model.EspecialesVO)GetRequestVar("publication");
%>
<script type="text/javascript" language="javascript">
var metaTags=<%=p.Meta %>;
</script>
  
		<h2>Publicaci&oacute;n Especial</h2>
		<br />
        <strong>
            <% if (p.Id > 0)
               { %>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" id="Position" name="Position" value="<%=p.Position %>" />
          ...
          <td rowspan="5" valign="top">Seccion:<br />
               &nbsp;&nbsp;&nbsp; 
               <select name="sectionId" id="sectionId" size="12">
                    <%=this.GetMessage("sectionTreeOptions") %>
                </select>
             </td>
           </tr>
        <tr>
